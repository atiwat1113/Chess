...
public class Sprites {
	...
	public static final String W_KING = "W_King.png";
	public static final String W_QUEEN = "W_Queen.png";
	public static final String W_BISHOP = "W_Bishop.png";
	public static final String W_KNIGHT = "W_Knight.png";
	public static final String W_ROOK = "W_Rook.png";
	public static final String W_PAWN = "W_Pawn.png";
	public static final String B_KING = "B_King.png";
	public static final String B_QUEEN = "B_Queen.png";
	public static final String B_BISHOP = "B_Bishop.png";
	public static final String B_KNIGHT = "B_Knight.png";
